...
void schedule() {
  if (PROCESS *p_first = find_first(process_queen1_head, process_queen1_tail);
    ...
    if (PROCESS *p_second =
      ...
      next_quene(process_queen2_head, process_queen2_tail, process_queen3_head,
                 process_queen3_tail, p_proc_ready, process_tail,
                 LAST_QUENE_SLICE);
    }
  } else {
    p_proc_ready = p_first;
    next_quene(process_queen1_head, process_queen1_tail, process_queen2_head,
               process_queen2_tail, p_proc_ready, process_tail,
               SECOND_QUENE_SLICE);
  }
}
// ------------------------------------------------------------------
